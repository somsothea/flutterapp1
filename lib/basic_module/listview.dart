  ...
  Widget _buildListView() {
    return Container(
      ...
      child: ListView(
        ...
        children: [
          Container(width: 280, height: 150, color: Colors.red),
          Container(width: 290, height: 100, color: Colors.blue),
          Container(width: 230, height: 100, color: Colors.lime),
          Container(width: 270, height: 200, color: Colors.pink),
          Container(width: 250, height: 180, color: Colors.indigo),
          Container(width: 230, height: 100, color: Colors.yellow),
          Container(width: 270, height: 200, color: Colors.purple),
          Container(width: 250, height: 180, color: Colors.cyan),
        ],
      ),
    );
  }

  Widget _buildFoodListView(dynamic foodList) {
    return ListView.builder(
      itemCount: foodList.length,
      itemBuilder: (context, index) {
        return Image.network(foodList[index]);
      },
    );
  }

  Widget _buildFootItem(String image) {
    return Container(
...
Widget _buildBottomAppBar() {
  return BottomAppBar(
    ...
    notchMargin: 6.0,
    child: SizedBox(
      height: 40, // Set height to ensure proper alignment
      child: Row(
